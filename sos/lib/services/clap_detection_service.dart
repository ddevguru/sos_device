...
class ClapDetectionService {
  ...
  // Sound threshold for detecting a clap (default ~68 dB for easy triggering)
  double _thresholdDb = 68.0;
  ...
  void _onNoiseData(NoiseReading reading) {
    ...
    if (maxDb >= _thresholdDb) {
      if (_firstClapTime == null) {
        ...
        // Check if second clap occurred within the valid double-clap window (200ms - 1500ms)
        if (diffMs >= 200 && diffMs <= 1500) {
